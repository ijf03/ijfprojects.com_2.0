...
function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="group relative rounded-2xl p-[1px] transition duration-300 hover:-translate-y-2">
      ...
      <div className="relative overflow-visible rounded-2xl border border-default bg-surface p-4 transition duration-300 group-hover:border-brand group-hover:shadow-[0_0_40px_rgba(44,181,160,0.16)]">
        {project.coverImage && (
